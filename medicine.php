...
$object->query = "
    ...
    -- INNER JOIN medicine_purchase_msbs 
    -- ON medicine_purchase_msbs.medicine_purchase_id = medicine_msbs.medicine_purchase_msbs 
    -- ORDER BY medicine_purchase_msbs.medicine_sale_price_per_unit ASC
";
